...
class RobotController():
    ...
    def start_robot(self):
        ...
        print("Robot started")
        commande1 = "cd ~/va_ws && source install/setup.bash && ros2 run va_controller mouvement  && read -p 'Appuyez sur Enter pour fermer le terminal'"
        commande2 = "ros2 run turtlesim turtlesim_node && read -p 'Appuyez sur Enter pour fermer le terminal'"
        commande3 = "rqt_graph && read -p 'Appuyez sur Enter pour fermer le terminal'"
...
class RobotControlUI:
    ...
    def update_coordinates(self):
        ...
        self.x_var.set(f'{x_g:.2f}')
        self.y_var.set(f'{y_g:.2f}')
        self.theta_var.set(f'{theta_g:.2f}')
